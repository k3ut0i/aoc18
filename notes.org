...
#+BEGIN_EXAMPLE
  ...
  04  eqrr 5 2 5  Is reg5 and reg2 equal in reg5
  05  addr 5 3 3  Increase reg3 value by reg5 amount
  06  addi 3 1 3  Jump over 7th instruction
  07  addr 1 0 0  reg0 = reg0 + reg1
  08  addi 4 1 4  Increase reg4 value
  09  gtrr 4 2 5  Is reg4 greater than reg2 in reg5
  10  addr 3 5 3  If reg5 is true goto 12
...
After drawing a simple flow chart we can see that this part of the problem is simple finding two numbers reg1 and reg4 such that reg1 * reg4 is reg2, i.e., divisors of reg2. and when it finds them reg0 = reg0 + reg1. So reg0 is sum of all divisors of reg2(10551418).
